                    ...
                    var html_start = `
                        ...
                        center += `
                             ...
                             <tr>
                                ...
                                <td>${count}</td><td>${user.full_name}</td><td>${user.email}</td><td>${user.phone_number}</td><td>${user.ticket_amount}</td><td><button onclick="deleteEvent(${user.id_registration})">Удалить</button></td>
                                </tr>          
